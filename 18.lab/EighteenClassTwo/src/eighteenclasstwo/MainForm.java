...
public class MainForm extends javax.swing.JFrame {
    ...
    private void createTable() {
        ...
        //tm.setValueAt(Math.PI/15, 0, 0);
        
        for (int i = 0; i < 14; i++) {
            Vector newRow = new Vector();
            double x = (Math.PI / 15) * (i + 1);
            newRow.add(x);
            newRow.add(Math.sin(x));
            newRow.add(Math.pow(Math.E, x) / x * Math.log10(x));
            tm.getDataVector().add(newRow);
        }
